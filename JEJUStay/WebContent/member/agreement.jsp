...
<div class="container" style="margin-left:550px;">
		<h4 class="display-4"><b>회원 가입</b></h4>
</div>
<br> 
<!-- onsubmit 이벤트는 form이 submit이 될 때 발생함. 실행된 함수가 false를 리턴하면 submit을 하지 않음. --> 
<form action="http://localhost:9000/JEJUStay/member/addMember.jsp" onsubmit="return send(this)"> 

<div class="container" style="margin-left:680px;">
		<h4 class="display-7"><b>전자상거래 표준약관</b></h4>
</div><br>

<table border="0" padding-top="5" cellspacing="3" cellpadding="3" align="center"> 
	<tr align="center" height="10"> 
		<td> <!-- 여기서는 textarea를 넣었으나 div태그나 iframe 형태로도 넣을 수 있음 --> 
			<textarea cols="70" rows="15" readonly>
제 1조 목적
이 약관은 (주)제주닷컴이 운영하는 제주여행전문 사이트 제주닷컴(이하 "사이트"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 이용자의 권리의무 및 책임사항을 규정함을 목적으로 합니다.
※「인터넷, 정보통신망, 모바일 및 스마트 장치 등을 이용하는 전자상거래에 대하여도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
제 2조 정의
1. "사이트"란 회사가 제주여행 상품 예약 (이하 “여행상품”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 여행상품 예약 등을 거래할 수 있도록 설정한 가상의 영업장을 의미합니다.
...
2. 회사는 불특정다수 회원에 대한 통지의 경우 1주일이상 사이트 공지사항(고객센터)에 게시함으로써 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.
...
2. 회사는 서비스의 운영과 관련하여 서비스 화면, 홈페이지, 이메일 등에 광고를 게재할 수 있습니다. 광고가 게재된 이메일 등을 수신한 이용자는 수신 거절의 의사표시를 할 수 있으며, 회사는 수신거절을 위한 방법을 이용자에게 제공합니다.
제 10조 구매신청
...
2. 수신확인통지를 받은 이용자는 의사표시의 불일치 등이 있는 경우에는 수신확인통지를 받은 후 즉시 예약신청 변경 및 취소를 요청할 수 있고, 회사는 예약 확정 전에 이용자의 요청이 있는 경우에는 지체없이 그 요청에 따라 처리하여야 합니다. (다만, 이미 대금을 지불한 경우에는 제17조의 청약철회 등에 관한 규정에 따릅니다.)
제 14조 할인쿠폰 적용
...
3. 할인쿠폰은 회사에서 별도로 명시한 경우를 제외하고는 타인에게 양도할 수 없으며, 부정한 목적이나 용도로 사용할 수 없습니다. 이를 위반한 경우 회사는 할인쿠폰을 소멸시키거나 이용자자격을 정지할 수 있습니다.
제 15조 여행상품 등의 공급
...
4. 회사는 이용자가 여행상품 예약완료 후, 여행상품의 이상 또는 전산상의 오류 등의 사유로 여행상품을 제공할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고, 사유발생일로부터 7일 이내에 계약해제 절차를 취합니다.
제 18조 청약철회 등의 효과
...
4. 기타 이 약관 및 사이트의 이용안내에 규정되지 않은 취소 및 환불에 대한 사항에 대해서는 소비자분쟁해결 기준에서 정한 바에 따릅니다.
제 19조 개인정보보호
...
4. 회사는 이용자로부터 제기되는 의견이나 불만이 정당하다고 객관적으로 인정될 경우에는 적절한 절차를 거쳐 즉시 처리하여야 합니다. 다만, 즉시 처리가 곤란한 경우에는 이용자에게 그 사유와 처리일정을 통보하여야 합니다.
...
<br>
<div class="container" style="margin-left:680px;">
		<h4 class="display-7"><b>국내여행표준약관</b></h4>
</div><br>
...
<table border="0" padding-top="5" cellspacing="3" cellpadding="3" align="center"> 
	<tr align="center" height="10"> 
		<td> 
			<textarea cols="70" rows="15" readonly>
제 1조 목적
이 약관은 (주)제주닷컴(이하 "당사"라 한다.)와 여행자가 체결한 국내여행계약의 세부이행 및 준수사항을 정함을 목적으로 합니다.
제 2조 여행사와 여행자 의무
...
③제1항의 규정에 의하지 아니하고 여행조건이 변경되거나 제13조 또는 제14조의 규정에 의한 계약의 해제 · 해지로 인하여 손해배상액이 발생한 경우에는 여행출발 전 발생 분은 여행출발 이전에, 여행 중 발생 분은 여행 종료 후 10일 이내에 각각 정산(환급)하여야 합니다.
...
<br>
<div class="container" style="margin-left:680px;">
		<h4 class="display-7"><b>개인정보수집 및 이용 동의</b></h4>
</div><br>
<table border="0" padding-top="5" cellspacing="3" cellpadding="3" align="center"> 
	<tr align="center" height="10"> 
		<td> 
			<textarea cols="70" rows="15" readonly>
1. 개인정보 수집에 대한 동의
(주)제주닷컴(이하 "당사"라고 합니다)는 이용자들이 회사의 개인정보 취급방침 또는 이용약관의 내용에 대하여 「동의」버튼 또는「취소」 버튼을 클릭할 수 있는 절차를 마련하여, 「동의」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다.
2. 개인정보의 수집목적 및 이용목적
"개인정보"라 함은 생존하는 개인에 관한 정보로서 당해 정보에 포함되어 있는 성명, 생년월일, 휴대폰 번호, 이메일 주소 등의 사항에 의하여 당해 개인을 식별할 수 있는 정보(당해 정보만으로는 특정 개인을 식별할 수 없더라도 다른 정보와 용이하게 결합하여 식별할 수 있는 것을 포함)를 말합니다. 대부분 서비스는 별도의 사용자 등록이 없이 언제든지 사용할 수 있습니다. 그러나 당사는 회원서비스를 통하여 이용자들에게 맞춤식 서비스를 비롯한 보다 더 향상된 양질의 서비스를 제공하기 위하여 이용자 개인의 정보를 수집하고 있습니다. 당사는 이용자의 사전 동의 없이는 이용자의 개인 정보를 공개하지 않으며, 수집된 정보는 아래와 같이 이용하고 있습니다.
가. 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금 정산 여행상품, 항공권, 호텔, 패스, 렌터카 등의 예약, 출입국 정보확인, 예약 내역 확인 및 상담, 여행 콘텐츠 제공, 여행 서비스 이용 시 회원 포인트 적립/조회/사용 및 이에 관한 안내, 상품 구매 및 요금결제, 물품 배송 또는 청구서 등 발송, 본인인증 및 금융서비스 등

나. 회원관리 회원제 서비스 제공, 개인식별, 당사 서비스 이용약관 위반 회원에 대한 이용제한 조치, 서비스의 원활한 운영에 지장을 미치는 행위 및 서비스 부정이용 행위 제재, 가입 의사 확인, 가입 및 가입횟수 제한, 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의 여부 확인, 추후 법정 대리인 본인 확인, 분쟁 조정을 위한 기록보존, 불만처리 등 민원처리, 고지사항 전달, 회원탈퇴 의사의 확인
다. 신규 서비스 개발 및 마케팅·광고에의 활용 신규 서비스 개발 및 맞춤 서비스 제공, 통계학적 특성에 따른 서비스 제공, 서비스의 유효성 확인, 이벤트 정보 및 참여기회 제공, 광고성 정보 제공, 접속빈도 파악, 회원의 서비스이용에 대한 통계
3. 수집하는 개인정보 항목 및 수집방법
가. 당사는 회원가입 시 서비스 제공과 편리하고 유익한 맞춤 정보를 제공하기 위해 필요한 최소한의 정보를 필수 사항으로 수집하고 있습니다.
나. 당사는 회원님의 소중한 인권을 침해할 우려가 있는 민감한 정보(인종, 사상 및 신조, 정치적 성향이나 범죄기록, 의료정보 등)는 어떠한 경우에도 수집하지 않으며, 만약 불가피하게 수집하는 경우에는 반드시 회원님에게 사전 동의를 구하겠습니다.
다. 당사는 회원님들의 개인정보를 다음과 같이 수집합니다.
수집한 개인정보의 이용 및 제 3자 제공 안내로 제공받는자 개인정보 항목 개인정보 이용목적 보유 및 이용기간으로 구성
수집·이용 목적
수집하는 개인정보의 항목
수집하는 개인정보의 수집방법
회원 가입 시
필수항목 : 아이디, 비밀번호, 이름, 성별, 생년월일, 휴대폰 번호, 주소, 이메일 주소 선택항목 : 이메일 수신 및 알림 서비스 동의여부 선택항목은 입력하지 않아도 회원가입이 가능합니다.
웹사이트 및 모바일 웹
여행상품 예약 및 상담 시
콘텐츠 제공, 구매 및 요금 결제, 개인 식별, 불만처리 등 민원처리, 고지사항 전달
웹사이트 및 모바일 웹
대금 결제 및 정산 시
결제를 위한 신용카드 정보, 은행 계좌 정보, 결제기록 등의 정보
현금영수증 발급을 위한 휴대폰 번호 또는 사업자등록번호
환불 절차에 필요한 은행 계좌 정보(선택)
웹사이트 및 모바일 웹
이벤트 참여 및 경품 배송 시
이름, 전화번호, 주소, 이메일 주소
웹사이트 및 모바일 웹
온라인 문의 및 게시글 작성 시
이름, 휴대폰 번호(선택), 이메일 주소(선택)
웹사이트 및 모바일 웹
기타
서비스 이용과정에서 자동 수집 정보 : IP Address, 쿠키, 방문 일시, 방문환경
자동 생성 · 수집
라. 당사는 다음과 같은 방법으로 개인정보를 수집합니다. 당사에서 운영하는 홈페이지 및 모바일 앱에서 회원가입, 여행상품 예약 및 구매, 온라인문의, 경품 행사 응모, 전화, 팩스를 통한 본인 확인 등 (주)제주닷컴상품을 판매하는 대리점에서 여행상품 예약 및 구매 생성정보 수집 툴을 통한 수집
4. 수집하는 개인정보의 보유 및 이용기간 및 파기
회사는 이용자의 개인정보를 원칙적으로 고지 및 약정한 기간 동안 보유 및 이용하며 개인정보의 수집 및 이용목적이 달성되면 지체 없이 파기합니다. 단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.
가. 관련법령 및 회사 방침에 의한 정보보유 사유
수집한 개인정보의 이용 및 제 3자 제공 안내로 제공받는자 개인정보 항목 개인정보 이용목적 보유 및 이용기간으로 구성
개인정보의 보유 근거
개인정보의 보유 항목
개인정보의 보유 기간
...
3개월-
회사 내부 방침
부정이용기록(불량 혹은 비정상 이용 기록) : 휴대전화번호, 이메일주소, 접속IP, 접속로그기록 채팅 및 댓글 내용
1년
...
5년
나. 수집된 개인정보의 보유, 이용기간은 서비스이용계약체결(회원가입)시부터 서비스이용계약해지(탈퇴신청, 직권탈퇴 포함)입니다. 또한 동의 해지 시 회사는 이용자의 개인정보를 상기 명시한 정보보유 사유에 따라 일정 기간 저장하는 자료를 제외하고는 지체 없이 파기하며 개인정보취급이 제 3자에게 위탁된 경우에는 수탁자에게도 파기하도록 지시합니다.
