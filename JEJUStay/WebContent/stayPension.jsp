      ...
      <div class="row">
        <div class="col">
          ...
          <ul class="nav nav-tabs" style="padding-top: 50px">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="http://localhost:9090/JEJUStay/stayPension.jsp">펜션</a>
            </li>
            <li class="nav-item">
	...
	<div class="container" style="margin-left:300px">
      <div class="row">      
        ...
        <%
				...
				ResultSet rs = null;
				String sql = "select * from tbl_stay where stay_type='펜션' and stay_fileRoom like '%_1';";
