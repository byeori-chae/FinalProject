...
public class BoardController extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String contextPath = request.getContextPath(); //http://localhost:9000/WebMarket/까지 주소의 길이 (뒤에 주소)BoardListAction.do?pageNum=1
		String command = RequestURI.substring(contextPath.length());//BoardListAction.do?pageNum=1 
